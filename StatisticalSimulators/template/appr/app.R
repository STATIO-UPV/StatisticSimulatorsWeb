################ LIBRERÍAS (Puedes añadir las necesarias, pero no eliminar ninguna). #####################
...
# Cambiar a FALSE si no se necesita barra de parámetros. 
...
# Para añadir una nueva traducción, dentro del diccionario seguir la estructura: 
# nueva_trad= c(
#   Es = "",
#   EN = "",
#   VAL = "")
...
ui <- fluidPage(
  ...
  # Crea los botones de idioma (arriba a la derecha). NO MODIFICAR. 
  absolutePanel(
